...
func sendConfirmation(trip Trip) {
	...
	payload := strings.NewReader("{" +
		"\"from\":{" + 
			"\"email\":\"clearwater.scheduling@austinspencer.works\"," +
			"\"name\":\"Trip Confirmation\"" +
		"}," +
		"\"subject\":\"Your Clearwater trip info\"," +
		"\"content\":[" +
			"{" +
				"\"type\":\"html\"," +
				"\"value\":\"Hello [%NAME%], your trip is scheduled for dates [%START%] to [%END%].\"" +
			"}," +
			"{" +
				"\"type\":\"html\"," +
				"\"value\":\"Be on the lookout for an email with further information when the start date of your trip gets closer.\"" +
			"}" +
		"]," +
		"\"personalizations\":[" +
		"{" +
